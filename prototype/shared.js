...
function buildSidebar() {
  const nav = [
    ...
    { name: 'Workbench', href: 'workbench.html', icon: 'layout', id: 'workbench', badge: 'New', badgeTone: 'preview' },
    { name: 'Factor Lab', href: 'factor-lab.html', icon: 'flask-conical', id: 'factor-lab', badge: 'Beta', badgeTone: 'beta' },
    { name: 'Strategy Builder', href: 'strategies.html', icon: 'file-code', id: 'strategies' },
    ...
    { name: 'AutoPilot 2.0', href: 'auto-pilot-2.html', icon: 'bot', id: 'auto-pilot-2', badge: 'New', badgeTone: 'preview' },
